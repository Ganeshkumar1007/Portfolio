...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_6o3j46m', 'template_8wqifs5', formRef.current, 'OsqbrRAgpbr0fbDEA')
          .then((result) => {
              setSuccess(true)
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>saraswathy877@gmail.com</span>
        </motion.div>
        <motion.div className="item">
          <h2>Address</h2>
          <span>Ariyankuppam, Puducherry</span>
        </motion.div>
        <motion.div className="item">
          <h2>Phone</h2>
          <span>9384460712</span>
        </motion.div>
      </motion.div>
